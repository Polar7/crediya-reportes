package co.com.pragma.reports.sqs.listener.helper;

import co.com.pragma.reports.sqs.listener.SQSProcessorMetricCredit;
import co.com.pragma.reports.sqs.listener.config.SQSProperties;
...
class SQSListenerTest {
    ...
    void listenerTest() {
        var sqsListener = SQSListener.builder()
                ...
                .processor(new SQSProcessorMetricCredit(reportMetricUseCase, new Gson()))
                .operation("operation")
                .build();
